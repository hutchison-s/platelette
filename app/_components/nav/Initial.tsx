  ...
  return (
    user 
      ...
      : <div className='size-8 text-sm aspect-square rounded-full border-1 border-background2 text-background2 font-light font-body grid place-items-center'>
        <Link href='https://auth.platelette.com/login?client_id=27a4hidci87i37h6ufhdg5mo4&response_type=code&scope=aws.cognito.signin.user.admin+email+openid+profile&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fauth-callback'>
